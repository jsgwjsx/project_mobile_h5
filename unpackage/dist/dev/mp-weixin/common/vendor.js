...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"sonw_1","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 33 */
/*!*****************************************!*\
  !*** D:/uniapp/sonw_1/utils/request.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 4);
var _index = _interopRequireDefault(__webpack_require__(/*! @/config/index.config */ 34));
module.exports = function (params) {
  // let url = indexConfig.baseUrl + params.url;					// 线上环境中开启
  var url = "/dpc/" + params.url; // 本地访问时开启
...
/* 34 */
/*!***********************************************!*\
  !*** D:/uniapp/sonw_1/config/index.config.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var CONFIG = {
  ...
  development: {
    assetsPath: '/static',
    // 静态资源路径
    baseUrl: 'https://administrator.dongtiyan.com',
    // 后台接口请求地址
    hostUrl: 'https://administrator.dongtiyan.com',
    // H5地址(前端运行地址)
    websocketUrl: '',
    // websocket服务端地址
...
/* 35 */
/*!*************************************************!*\
  !*** D:/uniapp/sonw_1/uni.promisify.adaptor.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 50 */
/*!***************************************************************************!*\
  !*** D:/uniapp/sonw_1/node_modules/@amap/amap-jsapi-loader/dist/index.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function (m, p) {
  "object" === ( false ? undefined : _typeof(exports)) && "undefined" !== typeof module ? module.exports = p() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (p),
  ...
  function p(a) {
    return new Promise(function (h, c) {
      var f = [];
      if (a.plugins) for (var e = 0; e < a.plugins.length; e += 1) {
      ...
      return new Promise(function (h, c) {
        if (g.AMap == b.failed) c("");else if (g.AMap == b.notload) {
          ...
          if (a.key && a.key !== d.key) c("\u591A\u4E2A\u4E0D\u4E00\u81F4\u7684 key");else if (a.version && a.version !== d.AMap.version) c("\u4E0D\u5141\u8BB8\u591A\u4E2A\u7248\u672C JSAPI \u6DF7\u7528");else {
            f = [];
            if (a.plugins) for (e = 0; e < a.plugins.length; e += 1) {
...
/* 80 */
/*!*********************************************!*\
  !*** D:/uniapp/sonw_1/utils/wgs842gcj02.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
